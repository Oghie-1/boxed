...
/**
 * check_chain - test if chaining is possible based on last status
 * @info: param struct
 * @buf: char buffer
...
/**
 * replace_alias - replace alias in tokenized str
 * @info: param struct
 *
...
/**
 * replace_vars - replace variable in tokenized str
 * @info: param struct
 *

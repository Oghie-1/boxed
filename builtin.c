#include "shell.h"
#include <unistd.h> // Added for the chdir and getcwd functions
...
int _myexit(info_t *info)
{
    ...
    return (0); // Added a return statement for cases where there is no exit argument
}
...
int _myhelp(info_t *info)
{
    ...
    if (arg_array != NULL && *arg_array != NULL)
    {
        _puts(*arg_array);
    }
